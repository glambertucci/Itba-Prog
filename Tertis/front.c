...
void al_draw_next_piece (PIECE future )
{
    ...
    {
        al_draw_filled_rectangle( SCREEN_W-SEPARACION*4, SEPARACION*3, SCREEN_W-SEPARACION*3, SEPARACION*6 , al_map_rgb(255,0,0));
        al_draw_filled_rectangle( SCREEN_W-SEPARACION*4, SEPARACION*5, SCREEN_W-SEPARACION*5, SEPARACION*6 , al_map_rgb(255,0,0));
    }
