 ...
 * s y c respectivamente y para el parpaedo con la letra b (Alteramos la funcion de parpadeo cosa que ahora las apagadas se prendan y las prendidas se apaguen) , o bien las tres 
